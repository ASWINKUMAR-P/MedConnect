...
export default function Editor() {
  ...
  return (
    <div style={{ height: "100%", marginTop: "13vh", zIndex: 1, backgroundColor: "white", marginLeft: "200px" }}>
      <div className="main">
              ...
              <div className="card mt-3">
                <div className="card-body">
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control" name="title" onChange={onChange} id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Title" />
              ...
              <div className="card mt-3">
                <div className="card-body">
                  <div className="form-group">
                    ...
                    <textarea name="question" onChange={onChange} className="form-control" id="questionTextarea" rows="3" placeholder="Enter your problem" style={{ borderRadius: "5px", padding: "10px" }} />
                    <small id="emailHelp" className="form-text text-muted">
              ...
              <div className="card mt-3">
                <div className="card-body">
                  <div className="form-group">
                    ...
                    />
                    <small id="emailHelp" className="form-text text-muted">
                      Enter the Tags and separate them by space. Use only alphabets.
                    </small>
                  </div>
                </div>
              </div>
